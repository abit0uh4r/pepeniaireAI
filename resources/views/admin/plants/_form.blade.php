<div class="space-y-8">
    ...
    <section class="border-t border-slate-100 pt-8">
        ...
        <div class="grid gap-5 sm:grid-cols-2">
            ...
            <div>
                <x-input-label for="exposure" value="Exposition" />
                <select id="exposure" name="exposure" class="mt-1 block w-full rounded-xl border-slate-300 shadow-sm focus:border-emerald-600 focus:ring-emerald-600" required>
                    @foreach ($exposures as $exposure)
                        <option value="{{ $exposure->value }}" @selected(old('exposure', isset($plant) ? $plant->exposure?->value : '') === $exposure->value)>{{ $exposure->label() }}</option>
                    @endforeach
                </select>
    ...
    <section class="border-t border-slate-100 pt-8">
        ...
        <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <label class="flex items-center gap-3 pt-7 text-sm font-medium text-slate-700 sm:col-span-2 lg:col-span-4">
